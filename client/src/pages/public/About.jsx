        ...
        <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center mb-8 md:mb-12">
                ...
                >
                    ...
                    <div className="relative aspect-[3/4] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl group border-[6px] md:border-[12px] border-white dark:border-slate-800 shadow-primary-theme/10">
                        <img
                            src="/advisor.jpg"
                            alt={t.about.name}
                ...
                <div className="w-full md:w-2/3 space-y-8">
                    ...
                    >
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-medium mt-4">
                            {t.about.intro}
                        </p>
                        <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-base mt-3">
                            {t.about.description}
                        </p>
                        <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-bold mt-3 mb-6">
                            {t.about.associatedWith} <span className="text-primary-theme">{t.stats.team}</span>.
                        </p>

                        <Link to="/about-details">
                            <Button variant="outline" className="rounded-full px-8 py-6 border-2 font-bold group hover:bg-primary-theme hover:text-white transition-all">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-8">
                            <div className="flex items-center gap-4 group p-2 transition-all">
                                <div className="bg-primary-theme/10 p-4 rounded-2xl group-hover:bg-primary-theme transition-colors duration-300">
                                    <BadgeCheck className="text-primary-theme w-6 h-6 group-hover:text-white transition-colors" />
                                </div>
                                <div>
                            ...
                            <div className="flex items-center gap-4 group p-2 transition-all">
                                <div className="bg-accent-theme/10 dark:bg-accent-theme/20 p-4 rounded-2xl group-hover:bg-accent-theme transition-colors duration-300">
                                    <Target className="text-accent-theme w-6 h-6 group-hover:text-white transition-colors" />
                                </div>
                                <div>
